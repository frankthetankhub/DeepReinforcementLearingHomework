...
class PPO(tf.keras.Model):
    ...
    #Were not sure why but the get_weights method returned a list of length 15 but the pre-implemented set_weights method needed only a length of 10.
...
if __name__ == "__main__":
    ...
    print("weights of pretrained model : {}".format(agent.model.get_weights()))
    print("length of model during testing : {}".format(len(agent.model.get_weights())))
    # This is where a length-error occured with the set_weights function
